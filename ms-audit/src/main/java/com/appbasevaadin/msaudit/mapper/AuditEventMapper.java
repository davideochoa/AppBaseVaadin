package com.appbasevaadin.msaudit.mapper;

import com.appbasevaadin.msaudit.dto.AuditEventResponse;
import com.appbasevaadin.msaudit.entity.AuditEvent;
import com.appbasevaadin.msaudit.messaging.AuditEventMessage;
import org.springframework.stereotype.Component;

/**
 * Single place for {@code AuditEvent} mapping in both directions: incoming Kafka message → entity
 * (used by {@link com.appbasevaadin.msaudit.messaging.AuditEventListener}) and entity → response
 * DTO (used by {@link com.appbasevaadin.msaudit.controller.AuditEventController}). Keeps that
